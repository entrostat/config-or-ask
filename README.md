...
config-or-ask/1.0.1 linux-x64 node-v16.15.0
...
_See code: [dist/commands/delete.ts](https://github.com/entrostat/config-or-ask/blob/v1.0.1/dist/commands/delete.ts)_
...
_See code: [dist/commands/get.ts](https://github.com/entrostat/config-or-ask/blob/v1.0.1/dist/commands/get.ts)_
